          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              <button
                type="button"
                className={
                  exportScope === "all" ? "btn-accent-sm" : "btn-secondary-sm"
                }
              ...
              <button
                type="button"
                className={
                  exportScope === "multi" ? "btn-accent-sm" : "btn-secondary-sm"
                }
          ...
          <div>
            ...
            <div className="flex gap-2">
              <button
                type="button"
                className={
                  exportFormat === "csv" ? "btn-accent-sm" : "btn-secondary-sm"
                }
              ...
              <button
                type="button"
                className={
                  exportFormat === "pdf" ? "btn-accent-sm" : "btn-secondary-sm"
                }
          ...
          <div className="flex items-center justify-between gap-3 pt-2 border-t border-white/10">
            ...
            <div className="flex gap-2">
              ...
              <button
                type="button"
                className={
                  getExportRows().length === 0 ? "btn-disabled" : "btn-accent"
                }
